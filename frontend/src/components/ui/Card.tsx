...
export const Card = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'bg-surface-subpanel border border-border-prominent rounded-lg shadow-keylight text-on-surface overflow-hidden',
        className
      )}
      {...props}
    />
...
export const CardFooter = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('p-5 pt-3 border-t border-border-subtle flex items-center justify-between', className)}
      {...props}
    />
  )
)
